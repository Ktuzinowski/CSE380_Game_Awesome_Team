 ...
 */
export default class SamLevel1 extends HW3Level {

    public static readonly PLAYER_SPAWN = new Vec2(245,1480);
    ...
    public constructor(viewport: Viewport, sceneManager: SceneManager, renderingManager: RenderingManager, options: Record<string, any>) {
        ...
        this.tilemapKey = SamLevel1.TILEMAP_KEY;
        this.tilemapScale = SamLevel1.TILEMAP_SCALE;
        this.destructibleLayerKey = SamLevel1.DESTRUCTIBLE_LAYER_KEY;
        this.sleepingSlimesLayerKey = SamLevel1.SLEEPING_SLIMES_LAYER_KEY;
        this.painfulSlimesLayerKey = SamLevel1.PAINFUL_SLIMES_LAYER_KEY;
        //this.fuelpackKey = Level1.FUELPACK_KEY;
        this.wallsLayerKey = SamLevel1.WALLS_LAYER_KEY;
        console.log(this.painfulSlimes);
        // Set the key for the player's sprite
        this.playerSpriteKey = SamLevel1.PLAYER_SPRITE_KEY;
        // Set the player's spawn
        this.playerSpawn = SamLevel1.PLAYER_SPAWN;

        // Music and sound
        this.levelMusicKey = SamLevel1.LEVEL_MUSIC_KEY
        this.jumpAudioKey = SamLevel1.JUMP_AUDIO_KEY;
        this.portalAudioKey = SamLevel1.PORTAL_AUDIO_KEY;
        this.painfulSlimeBounceAudioKey = SamLevel1.PAINFUL_SLIME_BOUNCE_AUDIO_KEY;
        this.slimeBounceAudioKey = SamLevel1.SLIME_BOUNCE_AUDIO_KEY;
        this.deathAudioKey = SamLevel1.DEATH_AUDIO_KEY;
        this.fuelpackAudioKey = SamLevel1.FUEL_PACK_KEY;
    ...
    public loadScene(): void {
        // Load in the tilemap
        this.load.tilemap(this.tilemapKey, SamLevel1.TILEMAP_PATH);
        // Load in the player's sprite
        this.load.spritesheet(this.playerSpriteKey, SamLevel1.PLAYER_SPRITE_PATH);
        // Audio and music
        this.load.audio(this.levelMusicKey, SamLevel1.LEVEL_MUSIC_PATH);
        this.load.audio(this.jumpAudioKey, SamLevel1.JUMP_AUDIO_PATH);
        this.load.audio(this.portalAudioKey, SamLevel1.PORTAL_AUDIO_PATH);
        this.load.audio(this.painfulSlimeBounceAudioKey, SamLevel1.PAINFUL_SLIME_BOUNCE_AUDIO_PATH);
        this.load.audio(this.slimeBounceAudioKey, SamLevel1.SLIME_BOUNCE_AUDIO_PATH);
        this.load.audio(this.deathAudioKey, SamLevel1.DEATH_AUDIO_PATH);
        this.load.audio(this.fuelpackAudioKey, SamLevel1.FUEL_PACK_PATH);
        this.load.audio(this.tileDestroyedAudioKey, SamLevel1.TILE_DESTROYED_PATH);
    }
